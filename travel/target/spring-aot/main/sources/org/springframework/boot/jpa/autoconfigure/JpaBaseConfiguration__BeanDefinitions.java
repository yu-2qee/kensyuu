...
public class JpaBaseConfiguration__BeanDefinitions {
  ...
  public static class PersistenceManagedTypesConfiguration {
    ...
    private static PersistenceManagedTypes getPersistenceManagedTypesInstance() {
      List<String> managedClassNames = List.of("com.example.travel.entity.House", "com.example.travel.entity.Reservation", "com.example.travel.entity.Role", "com.example.travel.entity.User", "com.example.travel.entity.VerificationToken");
