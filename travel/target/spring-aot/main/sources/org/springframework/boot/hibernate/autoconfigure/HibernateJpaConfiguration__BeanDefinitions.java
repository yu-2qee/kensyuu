...
public class HibernateJpaConfiguration__BeanDefinitions {
  ...
  private static BeanInstanceSupplier<EntityManagerFactoryBuilder> getEntityManagerFactoryBuilderInstanceSupplier(
    ...
    return BeanInstanceSupplier.<EntityManagerFactoryBuilder>forFactoryMethod(HibernateJpaConfiguration.class, "entityManagerFactoryBuilder", JpaVendorAdapter.class, ObjectProvider.class, ObjectProvider.class, ListableBeanFactory.class);
  }
