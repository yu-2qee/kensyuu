...
public class JacksonAutoConfiguration__BeanDefinitions {
  ...
  private static BeanInstanceSupplier<JsonFactory> getJsonFactoryInstanceSupplier() {
    return BeanInstanceSupplier.<JsonFactory>forFactoryMethod(JacksonAutoConfiguration.class, "jsonFactory", ObjectProvider.class)
  ...
  private static BeanInstanceSupplier<JsonMapper.Builder> getJsonMapperBuilderInstanceSupplier() {
    return BeanInstanceSupplier.<JsonMapper.Builder>forFactoryMethod(JacksonAutoConfiguration.class, "jsonMapperBuilder", ObjectProvider.class, JsonFactory.class)
